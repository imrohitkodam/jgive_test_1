                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <?php
                                                        ...
                                                        foreach($amountSuggestionsArray as $amtSug) { ?>
                                                            <button type="button"
                                                                    class="item-amount-suggestion btn btn-outline-primary mb-1"
                                                                    onclick="
                                                                        const input = document.getElementById('donation_amount');
                                                                        input.value = <?= $amtSug ?>;
                                                                        com_jgive.UI.Donation.updatePlatformFee(input, <?= $this->cdata['campaign']->id ?>);
                                                                        jgiveCommon.validateAmountAsPerCurrency(input, '<?= $this->params->get('allow_pan_verification'); ?>', <?= $this->params->get('pan_amount_limit'); ?>);
                                                                    ">
                                                                    <?= $this->currencySymbol . ' ' . $amtSug ?>
                                                            </button>
                                                        <?php }

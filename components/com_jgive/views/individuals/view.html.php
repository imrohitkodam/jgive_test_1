...
class JgiveViewIndividuals extends BaseHtmlView
{
	...
	protected function addTJtoolbar()
	{
		...
		{
			$tjbar->appendButton('individualform.add', 'TJTOOLBAR_NEW', '', 'class="btn '. $smallBtnClassName .' btn-success"');
		}
		...
		if (!empty($this->items) && $this->_layout == 'default')
		{
			...
			if ($this->canChange)
			{
				$tjbar->appendButton('individualform.edit', 'TJTOOLBAR_EDIT', '', 'class="btn '. $smallBtnClassName .' btn-success"');
			}

			// Edit individual contact state
			if ($this->canChangeState)
			{
				$tjbar->appendButton('individuals.publish', 'TJTOOLBAR_PUBLISH', '', 'class="btn '. $smallBtnClassName .' btn-success"');
				$tjbar->appendButton('individuals.unpublish', 'TJTOOLBAR_UNPUBLISH', '', 'class="btn '. $smallBtnClassName .' btn-warning"');
			}

			if ($this->canDelete)
			{
				$tjbar->appendButton('individuals.delete', 'TJTOOLBAR_DELETE', '', 'class="btn '. $smallBtnClassName .' btn-danger"');
			}

...
<div id="jgiveWrapper" class="<?php echo COM_JGIVE_WRAPPAER_CLASS;?> container">
	<div class="row mt-2">
		...
		<div class="col-xs-12 col-md-7 mt-3">
			<form action="<?php echo Route::_('index.php?option=com_jgive&view=campaigns&layout=all&Itemid=' . $this->otherData['allCampaignsItemid']);?>" method="post" name="adminForm4" id="adminForm4">
						...
						<li class="campaign__search">
							...
							<span class="pull-left search__campaign af-d-none search__campaign--wrapper" id="SearchFilterInputBox">
								<input type="text"
									...
									/>
								<button
									onclick="document.getElementById('filter_search').value=''; document.getElementById('adminForm4').submit();"
...
<script>
	...
	jQuery(document).ready(function(){
		...
		jQuery("#limit").attr('onchange', 'document.getElementById("adminForm4").submit()');

...
<div id="jgiveWrapper" class="row">
	<div class="col-md-12">
		...
		<form action="<?php echo Route::_('index.php?option=com_jgive&view=campaigns&layout=my&Itemid=' . $this->otherData['myCampaignsItemid']);?>" method="POST" name="adminForm" id="adminForm">
					...
					<div class="btn-toolbar pull-right mb-3">
						<div class="btn-group clearfix">
							...
							if ($this->params->get('show_type_filter_my_camp') && $campaignHelper->filedToShowOrHide('campaign_type'))
							{
								...
								echo HTMLHelper::_('select.genericlist', $this->campaign_type_filter_options, "filter_campaign_type", 'class="form-select" size="1" onchange="this.form.submit()"', "value", "text", $this->lists['filter_campaign_type']);
								?>
								&nbsp;
								<?php
							}?>
						...
						<div class="btn-group clearfix">
							...
							if ($this->params->get('show_category_filter_my'))
							{
								...
								echo HTMLHelper::_('select.genericlist', $this->cat_options, "filter_campaign_cat", 'class="form-select" size="1" onchange="this.form.submit()"', "value", "text", $this->lists['filter_campaign_cat']);
								?>
								&nbsp;
								<?php
							}?>
						...
						<div class="btn-group clearfix">
							...
							if ($this->params->get('show_org_ind_type_filter_my'))
							{
								...
								echo HTMLHelper::_('select.genericlist', $this->filter_org_ind_type, "filter_org_ind_type", 'class="form-select" size="1" onchange="this.form.submit()"', "value", "text", $this->lists['filter_org_ind_type']);
								?>
								&nbsp;
								<?php
							}
...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		jQuery("#limit").attr('onchange', 'document.getElementById("adminForm").submit()');

 ...
 * 
 * Template Override for Helix Ultimate - Fixed filter reset issue
 */
...
<div class="col-xs-12 col-sm-9">
	<form action="" name="jgHorizontalCoreFilters" method="post" id="jgHorizontalCoreFilters">
		<div class="row">
					...
					<div class="campaignsToShowFilterwrapper">
						<div>
							<label>
								...
								onclick="jgiveCommon.filters.submitFilters('jgHorizontalCoreFilters');"/>
			...
			<?php if ($showOrgIndType == 1) { ?>
				<div class="col-xs-12 col-sm-3">
					...
					'class="form-control" size="1" onchange="jgiveCommon.filters.submitFilters(\'jgHorizontalCoreFilters\');" name="filter_org_ind_type"',
			...
			<?php if ($showCountryFilter == 1) { ?>
				<div class="col-xs-12 col-sm-3">
					...
					'size="1" onchange="jgiveCommon.filters.submitFilters(\'jgHorizontalCoreFilters\');" class="form-control" name="filter_campaign_countries"',
					"value", "text", $lists['filter_campaign_countries']
					); ?>
					</br>
					<?php echo HTMLHelper::_(
					'select.genericlist', $campaign_states, "filter_campaign_states",
					'size="1" onchange="jgiveCommon.filters.submitFilters(\'jgHorizontalCoreFilters\');" class="form-control" name="filter_campaign_states"',
					"value", "text", $lists['filter_campaign_states']
					);?>
					</br>
					<?php echo HTMLHelper::_(
					'select.genericlist', $campaign_city, "filter_campaign_city",
					'size="1" onchange="jgiveCommon.filters.submitFilters(\'jgHorizontalCoreFilters\');" class="form-control" name="filter_campaign_city"',
